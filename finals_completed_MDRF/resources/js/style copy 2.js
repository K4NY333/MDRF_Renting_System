...
const closeOwnerPopup = document.getElementById("closeOwnerPopup");
const ownerForms = document.querySelectorAll(".owner-form");
...
ownerTabs.forEach((tab) => {
    tab.addEventListener("click", () => {
        ...
        ownerForms.forEach((f) => f.classList.remove("active"));
...
//close owner popup
closeOwnerPopup.addEventListener("click", () => {
